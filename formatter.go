...
// This code is mostly copied from https://github.com/sirupsen/logrus/blob/master/json_formatter.go
...
func (f *LogFormatter) Format(entry *logrus.Entry) ([]byte, error) {
	...
	if modifyFn := f.ModifyFields; modifyFn != nil {
		modifyFn(data)
	}
